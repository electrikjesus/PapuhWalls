...
public class ColorPickerDialog extends Dialog implements com.colorpicker.ColorPickerView.OnColorChangedListener, View.OnClickListener {
	private com.colorpicker.ColorPickerView mColorPicker;
	private com.colorpicker.ColorPickerPanelView mOldColor;
	private com.colorpicker.ColorPickerPanelView mNewColor;
	...
	private void setUp(int color) {
		...
		mColorPicker = (com.colorpicker.ColorPickerView) layout.findViewById(R.id.color_picker_view);
		mOldColor = (com.colorpicker.ColorPickerPanelView) layout.findViewById(R.id.old_color_panel);
		mNewColor = (com.colorpicker.ColorPickerPanelView) layout.findViewById(R.id.new_color_panel);
			...
			public void afterTextChanged(Editable s) {
				if (mHexValueEnabled) {
					...
					if (s.length() > 5 || s.length() < 10) {
						try {
							int c = com.colorpicker.ColorPickerPreference.convertToColorInt(s.toString());
